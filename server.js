...
app.get('/team_stats', function(req, res) {
  ...
  var query2 = 'select count(game_date) from football_games where home_score > visitor_score;';
  var query3 = 'select count(game_date) from football_games where visitor_score>home_score;';
